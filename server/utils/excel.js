...
//  Upsert helpers
// ─────────────────────────────────────────────
function upsertPatient(row, sourceFile) {
...
// ─────────────────────────────────────────────
function processExcelFile(filepath, fileId) {
          ...
          try {
            if (sheetType === 'patients') {
              ...
              if (!pid) {
                ...
                if (!found) upsertPatient(row, filename);
              }

              if (!pid) pid = upsertPatient(row, filename);
